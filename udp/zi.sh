...
BIN_URL="https://raw.githubusercontent.com/kayu55/uda/main/udp-zivpn-linux-amd64"

# Link Download config.json
CFG_URL="https://raw.githubusercontent.com/kayu55/uda/main/config.json"
